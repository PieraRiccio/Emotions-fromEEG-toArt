...
# Contains both generator and discriminator. Probably not going to change this too much. Only need to figure out the latent dimensions problem. 
...
if __name__ == '__main__':
    ...
    --> Need to figure out how different my latent dimensions are (according to the hyperparameter tuning of RGNN and how they adapt to this)
    """
