...
def extract_feature_from_samples(
    ...
    for batch in tqdm(batch_sizes):
        ...
        rgnn_latent = torch.stack([
          torch.tensor(np.load("anger_seed4_latent.npy"), device=device),
          torch.tensor(np.load("fear_seed4_latent.npy"), device=device),
          torch.tensor(np.load("sad_seed4_latent.npy"), device=device),
          torch.tensor(np.load("happy_seed4_latent.npy"), device=device)
        ])
        rgnn_latent = torch.cat(16*[rgnn_latent])
